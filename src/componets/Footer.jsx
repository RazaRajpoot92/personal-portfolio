    ...
    <div className=' bg-black px-20 py-4 relative '>
            ...
            <div className='flex justify-between my-4 mb-8'>
                    ...
                    <div className='text-gray-200 flex flex-col gap-3'>
                        ...
                        <button className=' border hover:text-indigo-500 ease-in duration-200 border-indigo-500 hover:bg-transparent hover:border hover:border-indigo-500 w-[100px] rounded-md py-2 bg-indigo-600 text-white'>Hire me</button>
                    </div>
